...
class ConsumeCommand(BaseCommand):
    ...
    def run(self, args: Namespace, update: telegram.Update) -> None:
        ...
        if isinstance(consumable, str) and consumable == "?":
            ...
            util.get_event_loop().run_until_complete(SDK.consume(consumable, args.number, sender))
    ...
    def get_consumable_help() -> str:
        ...
        lines = "\n".join([make_line(c) for c in util.get_event_loop().run_until_complete(SDK.get_consumables())])
